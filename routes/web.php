...
[HolidayController::class,'edit'])->name('holidays.edit');

Route::put('/holidays/{id}',
[HolidayController::class,'update'])->name('holidays.update');

Route::delete('/holidays/{id}',
[HolidayController::class,'destroy'])->name('holidays.delete');
/*
|--------------------------------------------------------------------------
...
// GET is allowed so a re-login redirect (Laravel stores the approve URL and
// resumes with GET) does not 405. Admin auth still protects these routes.
Route::match(['get', 'post'], '/leave/approve/{id}', [LeaveController::class, 'approve'])->name('leave.approve');
Route::match(['get', 'post'], '/leave/reject/{id}', [LeaveController::class, 'reject'])->name('leave.reject');
...
Route::middleware(['auth', 'salary'])
    ...
    */
    ...
    Route::get('/medical-insurance', [SalaryController::class,'medicalInsurance'])->name('salary.medical');
    Route::post('/medical-insurance', [SalaryController::class,'medicalInsuranceStore'])->name('salary.medical.store');
    Route::post('/medical-insurance/copy-previous', [SalaryController::class,'medicalInsuranceCopyPrevious'])->name('salary.medical.copy');
...
Route::middleware(['auth', 'loan'])
    ...
    ->group(function () {
        ...
        Route::post('/loans/{id}/ledger-entry', [LoanController::class, 'storeLedgerEntry'])->name('loan.ledger-entry.store');
        Route::get('/loans/ledger-entry/{id}/edit', [LoanController::class, 'editLedgerEntry'])->name('loan.ledger-entry.edit');
        Route::put('/loans/ledger-entry/{id}', [LoanController::class, 'updateLedgerEntry'])->name('loan.ledger-entry.update');
        Route::delete('/loans/ledger-entry/{id}', [LoanController::class, 'destroyLedgerEntry'])->name('loan.ledger-entry.delete');
    });
