...
<div class="bg-green-100 p-6 rounded-lg shadow text-center hover:shadow-lg transition">
...
<div class="bg-yellow-100 p-6 rounded-lg shadow text-center hover:shadow-lg transition">
...
<div class="bg-purple-100 p-6 rounded-lg shadow text-center hover:shadow-lg transition">
...
<div class="bg-blue-100 p-6 rounded-lg shadow text-center hover:shadow-lg transition">
...
<div class="bg-red-100 p-6 rounded-lg shadow text-center hover:shadow-lg transition">
...
<div class="bg-indigo-100 p-6 rounded-lg shadow text-center hover:shadow-lg transition">
