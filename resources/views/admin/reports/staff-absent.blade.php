...
<div class="max-w-7xl mx-auto py-6 px-4">
    ...
    <div class="print-header hidden mb-4" style="display: none;">
        <h1 class="text-xl font-bold">LSAF HR — Staff-wise Absence Report</h1>
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6 no-print">
        ...
        <div class="flex flex-wrap items-center gap-2">
            ...
            <a href="{{ route('admin.reports.absent.export', ['month' => $month, 'include_payroll_only' => ($includePayrollOnly ?? false) ? 1 : null]) }}"
